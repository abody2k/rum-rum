...
<div class="bg-white rounded p-7 shadow-xl max-w-md opacity-100">
...
<p> Room's title</p>
 ...
 <button class="p-2 rounded bg-red-500 text-white " (click)="createARoom()"> Create a room</button>
 <button class="p-2 rounded bg-red-500 text-white " (click)="closeWindow()"> Cancel</button>
 </div>
